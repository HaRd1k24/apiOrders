...
public class ElectronicSigarsDaoImpl implements ElectronicSigarsDao {

    private static final Logger log = LoggerFactory.getLogger(ElectronicSigarsDaoImpl.class);
